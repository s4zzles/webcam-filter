...
Start your webcam by pressing the "Start camera" button. It autamatically selects your first webcam if it's not currently being used by another program.
...
Kuwahara uses a fast approximation of the classic Kuwahara filter that is viable for real time filtering. You can choose different kernel sizes for increasing the size of the splotches.
